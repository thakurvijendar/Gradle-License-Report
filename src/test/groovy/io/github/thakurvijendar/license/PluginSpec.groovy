...
import static io.github.thakurvijendar.license.AbstractGradleRunnerFunctionalSpec.fixPathForBuildFile
...
class PluginSpec extends Specification {
    ...
    def "plugin should be applicable to a project"() {
        ...
        when:
        project.pluginManager.apply 'io.github.thakurvijendar.dependency-license-report'
